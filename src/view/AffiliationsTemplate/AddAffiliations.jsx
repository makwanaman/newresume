...
const AddAffiliations = ({ handleRemoval }) => {
  ...
  const affiliations = localStorage.getItem("resume_meta_value_affiliation");
  ...
  const handlePath = () => {
    ...
    const filterName = nameArr.filter((ele) => ele !== "Affiliations");
    let route = "";
    const pathArray = JSON.parse(localStorage.getItem("extra_section_array"));
    ...
    if (affiliations === null && description !== "") {
      ...
      navigate(route);
    } else if (affiliations !== null && description !== "") {
      dispatch(
        editAffiliation({
          data: description,
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="editor-box mt-3">
                ...
                {/* <PageHeading headinglabel={t("What are your affiliations?")} /> */}
                <div className="mt-3">
                  <CKEditor
                    config={{
                      toolbar: [
